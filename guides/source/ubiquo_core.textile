...
class Article < ActiveRecord::Base
  ...
  filtered_search_scopes :enable => [ :tag, :writter ]
  belongs_to :writter, :class_name => 'UbiquoUser', :foreign_key => 'user_id'
end
</ruby>
...
<ruby>
@articles = Article.filtered_search({"filter_writter" => 1, :order_by => 'published_at' })
</ruby>
